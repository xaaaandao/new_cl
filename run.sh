...
do
    ...
    do
        ...
        echo "=========================================="
        python main.py --eval --batch_sizes $batch --loss_weight $loss --use_pretrained --f1 macro
        python main.py --eval --batch_sizes $batch --loss_weight $loss --use_pretrained --f1 weighted
    done
done

...
def main():
    ...
    if args.train:
        ...
        train_loader = dm.get_loader(train_dir_path, is_contrastive=True)
    ...
    if args.eval:
        ...
        eval_train_loader = dm.get_loader(train_dir_path, is_contrastive=False)
        
        # Precisamos das features de teste para validar
        logger.info("Carregando loader de Teste...")
        eval_test_loader = dm.get_loader(test_dir_path, is_contrastive=False)
